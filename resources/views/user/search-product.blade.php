...
@section('container')
    <section class="product-section reveal active my-4 mb-5" id="product-recom-section ">
        ...
        <div class="header my-5 mb-3 mt-5">
            <h2 class="section-title text-center">Hasil Pencarian <span class="title-span">{{$search_product}}</span></h2>
            <p class="text-center">Pilih Penjahit Sesuai kebutuhan Anda.</p>
        </div>
                        ...
                        <a class="text-decoration-none" href="{{ route('detail', ['id' => $product->id]) }}">
                            <div class="pro-card rounded border p-3">
                                ...
                                <div class="pro-image d-flex align-items-center justify-content-center rounded">
                                    ...
                                    <img src="{{ asset('image/product/' . $product->detailGambarProduct[0]->gambar) }}" alt="{{ $product->nama_product }}" class="pro-animation img-fluid rounded" loading="lazy">
                                    @endif
                                </div>
