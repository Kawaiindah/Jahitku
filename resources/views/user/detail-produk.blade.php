            ...
            <div class="row border-bottom pb-4">
                    ...
                    <div class="row">
                        <figure class="product-display col">
                            <img class="h-100 w-100"
                                src="{{ asset('image/product/' . $product->detailGambarProduct[0]->gambar) }}" width="700"
                ...
                <div class="col-md-8 col-12">
                    <div class="row g-3">
                        ...
                        <!-- Harga Produk -->
                        <data class="product-price bg-body-secondary row col-12 px-3">{{ rupiah($product->harga) }}</data>
                        ...
                        <div class="product-text col-12">
                            ...
                            <p>Hub WA: <a href="https://wa.me/{{$product->toko->no_telp}}"><i style="color:green" class="fa-brands fa-whatsapp"></i> {{$product->toko->no_telp}}</a></p>
                        </div>
