...
<body>
    ...
    {{-- form searching --}}
    <div class="container">
        <form id="searchForm" method="GET" action="{{route('search-product')}}" class="form-inline" style="display: none;">
            <div class="input-group"> <!-- Tambahkan input-group -->
                <input name="search_product" type="text" class="form-control" placeholder="Cari Product">
